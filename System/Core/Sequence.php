...
class Sequence
{
     ...
     */
    public static function generate( int $categoryId, int $creatTimeStamp = 0 ): string
    {
        // TODO: 先鎖死 UTC + 0, 之後要確保每個主機的 timezone 都是 UTC + 0
        ...
        // 秒
        if ( empty( $creatTimeStamp ) )
        {
            $second = substr( $timestamp, 11 );
        }
        else
        {
            $second = $creatTimeStamp;
        }
